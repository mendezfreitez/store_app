  ...
  <div>
    ...
    >
      ...
      <b-navbar-nav class="text-left color-light" text-variant="light">
        ...
        <b-nav-item v-b-toggle.sidebar-backdrop v-for="categoria in categoriasTodas" :key="categoria._id" href="#" @click="traerProductosTodos(categoria._id)" class="pl-2 ddd" style="font-size:20px!important;font-family:'OverpassLight';font-weight:400!important;">
          {{ categoria.nombre }}
          <b-img height="40" right class="mr-4" :src="require('../editor/img/categorias/' + categoria.nombre + '.svg')" alt=""></b-img>
        </b-nav-item>

        <b-nav-item href="#" to="/personalizaTuCamiseta" class="pl-2" style="font-size:20px!important;font-family:'OverpassLight';font-weight:700!important;">
          Personalizado
        </b-nav-item>
      </b-navbar-nav>
...
.b-sidebar-body{
  background-color: rgb(185 72 72 / 81%) !important;
}
.b-sidebar-header {
